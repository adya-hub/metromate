...
export function SettingsPanel({ isOpen, onClose }: SettingsPanelProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="sticky top-0 p-6 border-b border-white/10 bg-gradient-to-r from-violet-600/10 via-blue-600/10 to-purple-600/10 backdrop-blur-xl">
        ...
        <div className="p-6 space-y-6">
          ...
          <motion.div
            ...
            className="p-6 rounded-2xl bg-gradient-to-br from-violet-600/10 via-blue-600/10 to-purple-600/10 border border-white/10"
          >
                ...
                <div className="space-y-2">
                  {section.items.map((item, itemIndex) => (
                    <motion.button
                      key={item.label}
                      whileHover={{ x: 4 }}
                      className="w-full p-4 rounded-xl bg-background/50 border border-white/10 hover:border-violet-500/50 transition-all flex items-center justify-between text-left group"
                    >
