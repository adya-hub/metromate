...
export function StatusBar() {
  ...
  return (
    <motion.div
      ...
      className="fixed top-20 right-6 z-40 hidden md:flex items-center gap-3 px-4 py-2 rounded-2xl bg-card/80 backdrop-blur-xl border border-white/10 shadow-xl"
    >
      {/* Time */}
