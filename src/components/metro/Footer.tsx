...
export function Footer() {
  ...
  return (
    <footer className="w-full mt-20 py-12 px-6 border-t border-border bg-card/50 backdrop-blur-xl hidden md:block">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                className="p-3 rounded-xl bg-background/50 hover:bg-violet-600/20 border border-border hover:border-violet-500/50 transition-all"
              >
